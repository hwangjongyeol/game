...
CREATE TABLE character_class_masters (
    ...
    render_profile_json LONGTEXT NULL,
...
INSERT INTO character_class_masters (
    class_id, class_name, base_attack, base_defense, base_hp, base_mp, render_profile_json, is_active
) VALUES
    ('knight', 'Knight', 26, 10, 240, 70, '{"spritePackKey":"warrior","block":{"col":0,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 1),
    ('mage', 'Mage', 30, 5, 180, 120, '{"spritePackKey":"mage","block":{"col":0,"row":1},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 1),
    ('ranger', 'Ranger', 28, 7, 210, 90, '{"spritePackKey":"archer","block":{"col":1,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 1)
ON DUPLICATE KEY UPDATE
    ...
    render_profile_json = VALUES(render_profile_json),
    is_active = VALUES(is_active);

INSERT INTO monster_masters (
    monster_id, monster_name, max_hp, max_mp, attack, defense,
    reward_gold, reward_gem, reward_exp, reward_score, sprite_key, render_profile_json, is_active
) VALUES
    ('slime-green', 'Green Slime', 170, 40, 16, 5, 45, 1, 35, 12, 'slime', '{"spritePackKey":"slime","block":{"col":1,"row":1},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 1),
    ('goblin-guard', 'Goblin Guard', 210, 50, 20, 8, 65, 1, 50, 20, 'goblin', '{"spritePackKey":"orc","block":{"col":0,"row":2},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 1),
    ('skeleton-warrior', 'Skeleton Warrior', 260, 70, 24, 10, 95, 2, 75, 30, 'skeleton', '{"spritePackKey":"orc","block":{"col":0,"row":2},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 1)
ON DUPLICATE KEY UPDATE
...
INSERT INTO companion_masters (
    ...
    image_url, render_profile_json, recruit_weight, is_active
) VALUES
    ('knight-s1', 'Iron Shield', 'COMMON', 'knight', 6, 5, 55, 8, '/companions/knight-s1.png', '{"spritePackKey":"warrior","block":{"col":0,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 120, 1),
    ('knight-s2', 'Stone Guard', 'COMMON', 'knight', 7, 6, 60, 6, '/companions/knight-s2.png', '{"spritePackKey":"warrior","block":{"col":0,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 120, 1),
    ('knight-s3', 'Royal Spear', 'RARE', 'knight', 11, 8, 85, 10, '/companions/knight-s3.png', '{"spritePackKey":"warrior","block":{"col":0,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 90, 1),
    ('knight-s4', 'Bastion', 'RARE', 'knight', 12, 9, 95, 12, '/companions/knight-s4.png', '{"spritePackKey":"warrior","block":{"col":0,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 85, 1),
    ('knight-s5', 'Crimson Aegis', 'EPIC', 'knight', 18, 12, 130, 16, '/companions/knight-s5.png', '{"spritePackKey":"warrior","block":{"col":0,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 50, 1),
    ('knight-s6', 'Paladin Rex', 'LEGEND', 'knight', 26, 16, 185, 22, '/companions/knight-s6.png', '{"spritePackKey":"warrior","block":{"col":0,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 20, 1),
    ('mage-s1', 'Spark Adept', 'COMMON', 'mage', 8, 3, 42, 20, '/companions/mage-s1.png', '{"spritePackKey":"mage","block":{"col":0,"row":1},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 120, 1),
    ('mage-s2', 'Rune Student', 'COMMON', 'mage', 9, 3, 45, 24, '/companions/mage-s2.png', '{"spritePackKey":"mage","block":{"col":0,"row":1},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 120, 1),
    ('mage-s3', 'Arc Scholar', 'RARE', 'mage', 13, 4, 62, 30, '/companions/mage-s3.png', '{"spritePackKey":"mage","block":{"col":0,"row":1},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 90, 1),
    ('mage-s4', 'Aether Witch', 'RARE', 'mage', 14, 5, 66, 34, '/companions/mage-s4.png', '{"spritePackKey":"mage","block":{"col":0,"row":1},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 85, 1),
    ('mage-s5', 'Storm Oracle', 'EPIC', 'mage', 21, 6, 92, 48, '/companions/mage-s5.png', '{"spritePackKey":"mage","block":{"col":0,"row":1},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 50, 1),
    ('mage-s6', 'Void Empress', 'LEGEND', 'mage', 30, 8, 128, 64, '/companions/mage-s6.png', '{"spritePackKey":"mage","block":{"col":0,"row":1},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 20, 1),
    ('ranger-s1', 'Forest Scout', 'COMMON', 'ranger', 8, 4, 46, 14, '/companions/ranger-s1.png', '{"spritePackKey":"archer","block":{"col":1,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 120, 1),
    ('ranger-s2', 'Longbow Kid', 'COMMON', 'ranger', 9, 4, 50, 16, '/companions/ranger-s2.png', '{"spritePackKey":"archer","block":{"col":1,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 120, 1),
    ('ranger-s3', 'Hawk Archer', 'RARE', 'ranger', 14, 6, 72, 22, '/companions/ranger-s3.png', '{"spritePackKey":"archer","block":{"col":1,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 90, 1),
    ('ranger-s4', 'Wind Sniper', 'RARE', 'ranger', 15, 6, 76, 24, '/companions/ranger-s4.png', '{"spritePackKey":"archer","block":{"col":1,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 85, 1),
    ('ranger-s5', 'Moon Ranger', 'EPIC', 'ranger', 22, 8, 104, 30, '/companions/ranger-s5.png', '{"spritePackKey":"archer","block":{"col":1,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 50, 1),
    ('ranger-s6', 'Sky Hunter', 'LEGEND', 'ranger', 32, 10, 146, 40, '/companions/ranger-s6.png', '{"spritePackKey":"archer","block":{"col":1,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 20, 1),
    ('hybrid-s1', 'Mercenary Ace', 'EPIC', 'knight', 20, 10, 110, 20, '/companions/hybrid-s1.png', '{"spritePackKey":"warrior","block":{"col":0,"row":0},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 45, 1),
    ('hybrid-s2', 'Myth Twin', 'LEGEND', 'mage', 34, 12, 160, 58, '/companions/hybrid-s2.png', '{"spritePackKey":"mage","block":{"col":0,"row":1},"battleFrames":[[0,0],[1,0],[2,0],[0,1],[1,1],[2,1]],"deathFrames":[[0,2],[1,2],[2,2]]}', 18, 1)
ON DUPLICATE KEY UPDATE
